...
public class gestionadministradores extends AppCompatActivity {
    ...
    private void mostrarVentanaCitasPendientes(Context context) {
        ...
        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) LinearLayout layoutCitas = popupView.findViewById(R.id.layout_citas);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot snapshot : dataSnapshot.getChildren()) {
                    ...
                    if (fecha != null && hora != null && ubicacion != null) {
                        ...
                        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) TextView tvFecha = cardView.findViewById(R.id.tvFecha);
                        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) TextView tvHora = cardView.findViewById(R.id.tvHora);
                        @SuppressLint({"MissingInflatedId", "LocalSuppress"}) TextView tvUbicacion = cardView.findViewById(R.id.tvUbicacion);
