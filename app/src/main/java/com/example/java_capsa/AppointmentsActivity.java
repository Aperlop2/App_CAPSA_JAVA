...
public class AppointmentsActivity extends AppCompatActivity {
    ...
    private com.example.java_capsa.CitaAdapter adapter;
    private List<com.example.java_capsa.Cita> citasList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new com.example.java_capsa.CitaAdapter(citasList, this, null); // Sin listener, solo mostrar citas
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for (DataSnapshot ds : snapshot.getChildren()) {
                            ...
                            if (citasUnicas.add(citaId)) {
                                citasList.add(new com.example.java_capsa.Cita(fecha + " " + hora, cuidador, ubicacion));
                            }
                        }
