...
public class EditarCita extends AppCompatActivity {
    ...
    private Button btnGuardarCitaEditar, btnCancelarCitaEditar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnGuardarCitaEditar = findViewById(R.id.btnGuardarCitaEditar);
        btnCancelarCitaEditar = findViewById(R.id.btnCancelarCitaEditar);
